// Kruskal's Algorithm using the Disjoint Set data structure involves sorting the edges 
// by weight and repeatedly adding the smallest edge that does not form a cycle.
#include <stdio.h>
#include <stdlib.h>
